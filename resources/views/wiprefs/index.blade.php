            ...
            <div class="modal-dialog modal-dialog-top" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-danger waves-effect btn-label waves-light" id="sb-deleteselected" onclick="bulkDeleted('{{ route('wipref.deleteselected', ['id' => $id]) }}')"><i class="mdi mdi-delete label-icon"></i>Delete</button>
                    </div>
                </div>
            </div>
        </div>
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="mb-3">
                                                        <label class="form-label">Raw Material</label>
                                                        <select class="form-select js-example-basic-single" style="width: 100%" name="id_master_raw_materials" required>
                                                            <option value="" selected>--Select Raw Material--</option>
                                                            @foreach($rawmaterials as $item)
...
<script>
    $(function() {
        var i = 1;
        var url = '{!! route('wipref.index', encrypt($id)) !!}';
