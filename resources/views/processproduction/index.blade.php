        ...
        <div class="modal fade" id="deleteselected" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-top" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-light" data-bs-dismiss="modal">Close</button>
                        <button type="submit" class="btn btn-danger waves-effect btn-label waves-light" id="sb-deleteselected" onclick="bulkDeleted('{{ route('processproduction.deleteselected') }}')"><i class="mdi mdi-delete label-icon"></i>Delete</button>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <table class="table table-bordered dt-responsive w-100" id="server-side-table" style="font-size: small">
                            <thead>
                                <tr>
                                    ...
                                    <th class="align-middle text-center">Result Location Code</th>
...
<script>
    $(function() {
        var i = 1;
        var url = '{!! route('processproduction.index') !!}';
        ...
        var dataTable = $('#server-side-table').DataTable({
            ...
            columns: [{
                ...
                {
                    data: 'result_location_code',
                    name: 'result_location_code',
                    orderable: true,
                    searchable: true,
                    className: 'align-middle text-center',
                },
