        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">List Operator of <b class="text-primary">"{{ $rg->regu }}"</b></h4>
            ...
            <div class="modal-dialog modal-dialog-top" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-danger waves-effect btn-label waves-light" id="sb-deleteselected" onclick="bulkDeleted('{{ route('operator.deleteselected', ['id' => $id]) }}')"><i class="mdi mdi-delete label-icon"></i>Delete</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <table class="table table-bordered dt-responsive nowrap w-100">
                    <tbody>
                        <tr>
                            <td class="align-middle"><b>Regu Code</b></td>
                            <td class="align-middle">: {{ $rg->regu_code }}</td>
                        </tr>
                        <tr>
                            <td class="align-middle"><b>Regu</b></td>
                            <td class="align-middle">: {{ $rg->regu}}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control" name="id_master_regus" type="hidden" value="{{ $rg->id }}">
                                                        <input class="form-control" name="" type="text" value="{{ $rg->regu}}" style="background-color:rgb(197, 197, 197)" placeholder="Input Department.." required readonly disabled>
                                                    </div>
                                                </div>
                                                <div class="col-lg-12">
                                                    <div class="mb-3">
...
<script>
    $(function() {
        var i = 1;
        var url = '{!! route('operator.index', encrypt($id) ) !!}';
