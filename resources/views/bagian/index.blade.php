...
<div class="page-content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">List Bagian of <b class="text-primary">"{{ $department->name}}"</b></h4>
            ...
            <div class="modal-dialog modal-dialog-top" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-danger waves-effect btn-label waves-light" id="sb-deleteselected" onclick="bulkDeleted('{{ route('bagian.deleteselected', ['id' => $department->id]) }}')"><i class="mdi mdi-delete label-icon"></i>Delete</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        {{-- Modal Search --}}
        <div class="modal fade" id="sort" data-bs-backdrop="static" data-bs-keyboard="false" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ route('bagian.index', encrypt($id)) }}" id="formfilter" method="POST" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" name="code" type="text" value="{{ $code }}" placeholder="Input Bagian Code..">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        <label class="form-label">Bagian</label>
                                        <input class="form-control" name="name" type="text" value="{{ $name }}" placeholder="Input Bagian..">
                                    </div>
                                </div>
        ...
        <div class="row">
            <div class="col-12">
                <table class="table table-bordered dt-responsive nowrap w-100">
                    <tbody>
                        <tr>
                            <td class="align-middle"><b>Department Code</b></td>
                            <td class="align-middle">: {{ $department->departement_code }}</td>
                        </tr>
                        <tr>
                        ...
                        <div class="modal fade" id="add-new" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-top" role="document">
                                <div class="modal-content">
                                    ...
                                    <form action="{{ route('bagian.store', encrypt($id)) }}" id="formadd" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control" name="id_master_departements" type="hidden" value="{{ $department->id }}">
                                                        <input class="form-control" name="" type="text" value="{{ $department->name}}" style="background-color:rgb(197, 197, 197)" placeholder="Input Department.." required readonly disabled>
                                                    </div>
                                                </div>
                                                <div class="col-lg-12">
                                                    <div class="mb-3">
                                                        <label class="form-label">Bagian Code</label><label style="color: darkred">*</label>
                                                        <input class="form-control" name="code" type="text" value="" placeholder="Input Bagian Code.." required>
                                                    </div>
                                                </div>
                                                <div class="col-lg-12">
                                                    <div class="mb-3">
                                                        <label class="form-label">Bagian</label><label style="color: darkred">*</label>
                                                        <input class="form-control" name="name" type="text" value="" placeholder="Input Bagian.." required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<script>
    $(function() {
        var i = 1;
        var url = '{!! route('bagian.index', encrypt($id) ) !!}';
        var currentDate = new Date();
        var formattedDate = currentDate.toISOString().split('T')[0];
        var fileName = "Master Bagian Export - " + formattedDate + ".xlsx";
        var data = {
                code: '{{ $code }}',
                name: '{{ $name }}',
                status: '{{ $status }}',
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        if(row.status == 'Active'){
                            ...
                            html = '<span class="badge bg-danger text-white">Innactive</span>';
                        }
                        return html;
                    },
                },
