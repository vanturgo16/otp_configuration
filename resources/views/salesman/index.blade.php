                                    ...
                                    <form action="{{ route('salesman.store') }}" id="formadd" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="mb-3">
                                                        <label class="form-label">Salesman Code</label><label style="color: darkred">*</label>
                                                        <input class="form-control" name="salesman_code" type="text" value="" placeholder="Input Salesman Code.." required>
                                                    </div>
                                                </div>
                                                <div class="col-lg-12">
                                                    <div class="mb-3">
                                                        <label class="form-label">Salesman Name</label><label style="color: darkred">*</label>
        ...
        <div class="modal fade" id="deleteselected" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-top" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-light" data-bs-dismiss="modal">Close</button>
                        <button type="submit" class="btn btn-danger waves-effect btn-label waves-light" id="sb-deleteselected" onclick="bulkDeleted('{{ route('salesman.deleteselected') }}')"><i class="mdi mdi-delete label-icon"></i>Delete</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal fade" id="sort" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ route('salesman.index') }}" id="formfilter" method="POST" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" name="salesman_code" type="text" value="{{ $salesman_code }}" placeholder="Input Salesman Code..">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        <label class="form-label">Salesman Name</label>
                                        <input class="form-control" name="name" type="text" value="{{ $name }}" placeholder="Input Salesman Name..">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="mb-3">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header text-center py-3">
                        <h5 class="mb-0"><b>Master Salesman</b></h5>
                        List of 
                        @if($salesman_code != null)
                            (Code<b> - {{ $salesman_code }}</b>)
                        @endif
                        @if($name != null)
                            (Name<b> - {{ $name }}</b>)
                        @endif
