        ...
        <div class="modal fade" id="deleteselected" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-top" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-light" data-bs-dismiss="modal">Close</button>
                        <button type="submit" class="btn btn-danger waves-effect btn-label waves-light" id="sb-deleteselected" onclick="bulkDeleted('{{ route('costcenter.deleteselected') }}')"><i class="mdi mdi-delete label-icon"></i>Delete</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal fade" id="sort" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ route('costcenter.index') }}" id="formfilter" method="POST" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" name="cost_center_code" type="text" value="{{ $cost_center_code }}" placeholder="Input Cost Center Code..">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        <label class="form-label">Cost Center Name</label>
                                        <input class="form-control" name="cost_center" type="text" value="{{ $cost_center }}" placeholder="Input Cost Center Name..">
                                    </div>
                                </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header text-center py-3">
                        <h5 class="mb-0"><b>Master Cost Center</b></h5>
                        List of 
                        @if($cost_center_code != null)
                            (Code<b> - {{ $cost_center_code }}</b>)
                        @endif
                        @if($cost_center != null)
                            (Cost Center<b> - {{ $cost_center }}</b>)
                        @endif
                        @if($status != null)
                            (Status<b> - {{ $status }}</b>)
                        @endif
...
<script>
    $(function() {
        var i = 1;
        var url = '{!! route('costcenter.index') !!}';
        ...
        var fileName = "Master Cost Center Export - " + formattedDate + ".xlsx";
        var data = {
