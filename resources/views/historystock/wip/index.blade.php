...
<div class="modal fade" id="sort" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form class="formLoad" action="{{ route('historystock.wip') }}" method="GET" enctype="multipart/form-data">
                @csrf
...
<div class="modal fade" id="exportModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form id="exportForm" action="{{ route('historystock.wip.export') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-body py-8 px-4" style="max-height: 67vh; overflow-y: auto;">
                    <div class="row">
                    ...
                    exportButtons.forEach(button => {
                        button.addEventListener("click", function (e) {
                            ...
                            .then(blob => {
                                ...
                                const fileName = `${fileTypeName}_Stock_WIP_${formattedDate}.${fileExtension}`;
