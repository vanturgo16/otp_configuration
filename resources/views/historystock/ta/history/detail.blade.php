            ...
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <div class="page-title-left">
                        <a href="{{ route('historystock.ta.history', encrypt($product->id)) }}?idUpdated={{ $id }}" class="btn btn-light waves-effect btn-label waves-light">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('historystock.ta') }}?idUpdated={{ $product->id }}">List Stock TA</a></li>
                            <li class="breadcrumb-item"><a href="{{ route('historystock.ta.history', encrypt($product->id)) }}?idUpdated={{ $id }}">{{ $product->code ?? '' }}</a></li>
        ...
        <div class="row">
            ...
            <div class="col-12">
                ...
                @else
                    ...
                    <script>
                        $(function() {
                            var url = '{!! route('historystock.ta.detail', [encrypt($id), $tableJoin]) !!}';
