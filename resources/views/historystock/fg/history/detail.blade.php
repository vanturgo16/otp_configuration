            ...
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <div class="page-title-left">
                        <a href="{{ route('historystock.fg.history', encrypt($product->id)) }}" class="btn btn-light waves-effect btn-label waves-light">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('historystock.fg.history', encrypt($product->id)) }}">{{ $product->product_code ?? '' }}</a></li>
