            ...
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <div class="page-title-left">
                        <a href="{{ route('historystock.fg') }}?idUpdated={{ $id }}" class="btn btn-light waves-effect btn-label waves-light">
                            <i class="mdi mdi-arrow-left label-icon"></i> Back To List Stock FG
                        </a>
                    </div>
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Master Data</a></li>
                            <li class="breadcrumb-item"><a href="{{ route('historystock.fg') }}?idUpdated={{ $id }}">List Stock FG</a></li>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header bg-light p-3">
                        <div class="row">
                            <div class="col-6">
                                <h6><b>{{ $detail->product_code ?? '' }}</b> {{ $detail->description ?? '' }}</h6>
                            </div>
                            <div class="col-6">
                                <div class="text-end">
...
<script>
    $(function() {
        var url = '{!! route('historystock.fg.history', encrypt($id)) !!}';
...
<div class="modal fade" id="sort" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            ...
            <form class="formLoad" action="{{ route('historystock.fg.history', encrypt($id)) }}" method="GET" enctype="multipart/form-data">
                @csrf
...
<div class="modal fade" id="exportModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top modal-md" role="document">
        <div class="modal-content">
            ...
            <form id="exportForm" action="{{ route('historystock.fg.export.prod', encrypt($id)) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-body py-8 px-4" style="max-height: 67vh; overflow-y: auto;">
                    <div class="row">
                        <div class="col-6 mb-2">
                ...
                document.addEventListener("DOMContentLoaded", function () {
                    ...
                    exportForm.addEventListener("submit", function (event) {
                        ...
                        .then(blob => {
                            ...
                            let filename = `Export_Stock_FG_Product_${formattedDate}.xlsx`;
