        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">List Product FG</h4>
                                        ...
                                        <div class="modal-body py-8 px-4" style="max-height: 67vh; overflow-y: auto;">
                                            <div class="row">
                                                ...
                                                <div class="col-6 mb-2">
                                                    ...
                                                    <select class="form-control" name="sales_price_currency">
                                                ...
                                                <div class="col-6 mb-2">
                                                    ...
                                                    <select class="form-control" name="based_price_currency">
                                                        <option value="" selected>--Select Currency--</option>
                                                        @foreach($currencies as $cr)
                                                            <option value="{{ $cr->id }}">{{ $cr->currency }}</option>
                                                        @endforeach
