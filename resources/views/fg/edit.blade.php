                            ...
                            <div class="card mt-2" style="background-color:rgb(236, 236, 236)">
                                <div class="row px-3 mb-2">
                                    ...
                                    <div class="col-6 mb-2">
                                        ...
                                        <select class="form-select js-example-basic-single" style="width: 100%" name="width_unit">
                                            <option value="" selected>--Select Unit--</option>
                                            @foreach($widthunits as $widthunit)
                                                <option value="{{ $widthunit->name_value }}" @if($data->width_unit === $widthunit->name_value) selected="selected" @endif>{{ $widthunit->name_value }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-6 mb-2">
                                        ...
                                        <input class="form-control" name="height" type="text" value="{{ $data->height }}" placeholder="Input Length..">
                                    </div>
                                    <div class="col-6 mb-2">
                                        <label class="form-label">Length Unit</label>
                                        <select class="form-select js-example-basic-single" style="width: 100%" name="height_unit">
                                            <option value="" selected>--Select Unit--</option>
                                            @foreach($lengthunits as $lengthunit)
                                                <option value="{{ $lengthunit->name_value }}" @if($data->height_unit === $lengthunit->name_value) selected="selected" @endif>{{ $lengthunit->name_value }}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="card mt-2" style="background-color:rgb(236, 236, 236)">
                                <div class="row px-3 mb-2">
                                    ...
                                    <div class="col-6 mb-2">
                                        ...
                                        <input class="form-control" name="based_price" type="text" value="{{ $data->based_price }}" placeholder="Input Based Price.." style="background-color:rgb(197, 197, 197)" readonly>
                                    </div>
                                    <div class="col-6 mb-2">
